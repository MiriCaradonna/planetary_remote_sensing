...
from radiative_transfer_paul import (cloud_visible_brightness, integrate_opacity_nadir,
...
def plot_comparison_tau(obs1, obs2, tau, label1, label2, label3, title):
    """Helper function to plot and compare two sets of observations
    ...
    try:
        ...
        vis_rad3, ir_rad3, heights_out, _ = obs1.generate_nadir_obs(
            dust_tau_true=tau[2],
            surface_albedo_true=0.25,
            surface_temp=surface_temp,
            emission_angles=angles,
        ...
        vis_limb3, ir_limb3, heights_out, _ = obs2.generate_limb_obs(
            dust_tau_true=tau[2],
            tangent_heights=heights,
            surface_temp=surface_temp,
            noise_visible=noise_visible,
...
def plot_brightness_temps_tau(obs1, obs2, tau, label1, label2, label3, title):
    """Helper function to plot brightness temperature comparisons with error bars"""
    try:
        rad = RadiationFundamentals()
        ...
        _, ir_rad3, angles_out, _ = obs1.generate_nadir_obs(
            dust_tau_true=tau[2],
            surface_albedo_true=0.25,
            surface_temp=surface_temp,
            emission_angles=angles,
        ...
        _, ir_limb3, heights_out, _ = obs2.generate_limb_obs(
            dust_tau_true=tau[2],
            tangent_heights=heights,
            surface_temp=surface_temp,
            noise_visible=noise_visible,
