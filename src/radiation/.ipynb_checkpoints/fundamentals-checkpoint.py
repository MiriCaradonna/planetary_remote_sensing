...
class Radiation:
    ...
    def brightness_temperature ( self , radiance , band_center , band_width ) :
        ...
        #print(f"Integrated Radiance: {integrated_radiance}")
